...
import streamz.akka.stream.AkkaStreamPublisher._
import streamz.akka.stream.AkkaStreamSubscriber._
...
trait ConverterSyntax extends Converter {
  implicit class AkkaSourceSyntax[O, M](source: Graph[SourceShape[O], M]) {
  ...
  implicit class AkkaSinkSyntax[I, M](sink: Graph[SinkShape[I], M]) {
  ...
  implicit class AkkaFlowSyntax[I, O, M](flow: Graph[FlowShape[I, O], M]) {
  ...
  implicit class FS2StreamNothingSyntax[O](stream: Stream[Nothing, O]) {
  ...
  implicit class FS2StreamPureSyntax[O](stream: Stream[Pure, O]) {
    /** @see [[Converter#fs2StreamToAkkaSource]] */
    def toSource(implicit executionContext: ExecutionContext): Graph[SourceShape[O], NotUsed] =
      fs2StreamToAkkaSource(stream)
  }

  implicit class FS2StreamTaskSyntax[O](stream: Stream[Task, O])(implicit executionContext: ExecutionContext) {
    /** @see [[Converter#fs2StreamToAkkaSource]] */
    def toSource(implicit executionContext: ExecutionContext): Graph[SourceShape[O], NotUsed] =
      fs2StreamToAkkaSource(stream)
  }

  implicit class FS2SinkPureSyntax[I](sink: Sink[Pure, I])(implicit executionContext: ExecutionContext) {
  ...
  implicit class FS2SinkTaskSyntax[I](sink: Sink[Task, I])(implicit executionContext: ExecutionContext) {
    /** @see [[Converter#fs2SinkToAkkaSink]] */
    def toSink(implicit executionContext: ExecutionContext): Graph[SinkShape[I], Future[Done]] =
      fs2SinkToAkkaSink(sink)
  }

  implicit class FS2PipePureSyntax[I, O](pipe: Pipe[Pure, I, O])(implicit executionContext: ExecutionContext) {
  ...
  implicit class FS2PipeTaskSyntax[I, O](pipe: Pipe[Task, I, O])(implicit executionContext: ExecutionContext) {
    /** @see [[Converter#fs2PipeToAkkaFlow]] */
    def toFlow(implicit executionContext: ExecutionContext): Graph[FlowShape[I, O], NotUsed] =
      fs2PipeToAkkaFlow(pipe)
  }
